      ...
      onCodePathEnd: function(codePath, codePathNode) {
        ...
        function countPathsFromStart(segment) {
          ...
          if (codePath.thrownSegments.includes(segment)) {
            ...
            try {
              for (
                var _iterator2 = segment.prevSegments[Symbol.iterator](),
                  _step2;
        ...
        function countPathsToEnd(segment) {
          ...
          if (codePath.thrownSegments.includes(segment)) {
            ...
            try {
              for (
                var _iterator4 = segment.nextSegments[Symbol.iterator](),
                  _step4;
        ...
        var isSomewhereInsideComponentOrHook = isInsideComponentOrHook(
          codePathNode
        );
        ...
        try {
          for (
            var _iterator6 = codePath.finalSegments[Symbol.iterator](), _step6;
