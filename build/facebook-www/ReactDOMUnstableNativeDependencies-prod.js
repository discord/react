...
function executeDirectDispatch(event) {
  ...
  Array.isArray(dispatchListener) ? reactProdInvariant("103") : void 0;
...
function getTouchIdentifier(_ref) {
  ...
  null == _ref ? reactProdInvariant("138") : void 0;
  return _ref;
}
...
function accumulate(current, next) {
  null == next ? reactProdInvariant("29") : void 0;
  return null == current
    ? next
...
var eventTypes = {
  ...
  ResponderEventPlugin = {
    ...
    extractEvents: function(
      ...
      JSCompiler_temp$jscomp$0 =
        responderInst && "touchcancel" === topLevelType;
      if (
        (topLevelType =
          ...
          if ((topLevelType = nativeEvent.touches) && 0 !== topLevelType.length)
            for (targetInst = 0; targetInst < topLevelType.length; targetInst++)
              if (
                ...
                tempA = getInstanceFromNode$1(depthA);
                b: {
