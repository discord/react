  ...
  for (
    ...
    if (5 === node.tag || 6 === node.tag) {
      ...
      currentParentIsContainer
        ? ((root = currentParent),
          recursivelyUncacheFiberNode(stateNode),
          UIManager.manageChildren(root, [], [], [], [], [0]))
        : ((root = currentParent),
          (node$jscomp$0 = stateNode),
          recursivelyUncacheFiberNode(node$jscomp$0),
          (stateNode = root._children),
          (node$jscomp$0 = stateNode.indexOf(node$jscomp$0)),
          stateNode.splice(node$jscomp$0, 1),
          UIManager.manageChildren(
            root._nativeTag,
            [],
            [],
